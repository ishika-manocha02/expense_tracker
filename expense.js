...
function add_expense_(){
	var amount=document.getElementsByClassName("form-input").amount.value;
	var date=document.getElementsByClassName("form-input").date.value;
	var note=document.getElementsByClassName("form-input").note.value;
	var category=document.querySelector("#category1").selectedIndex;
	console.log(category.value)
	var selected=document.getElementsByTagName("option")[1].value;
